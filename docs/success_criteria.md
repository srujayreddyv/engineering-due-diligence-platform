...
| S06 | Generated-claim grounding | 100% of material report conclusions reference valid evidence or policy finding identifiers | Automated reference validation and manual review of all evaluation reports |
...
| S10 | Structured output validity | 100% of accepted AI-assisted reports conform to the approved schema and contain only resolvable references | Schema and reference validation; invalid-output tests |
...
| C02 | Evidence traceability task | At least 90% of sampled material conclusions can be traced by a reviewer to the cited evidence or policy finding without facilitator correction | Give each role a fixed set of traceability tasks and record task completion |
...
| C07 | Workflow fit | No required step is judged unusable by more than one stakeholder role without an identified scope-compatible mitigation | Structured feedback form with reason and proposed mitigation |
